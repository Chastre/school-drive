<%-- 
    Document   : eliminar_veiculo
    Created on : 16/12/2025, 14:58:50
    Author     : pmnch
--%>
...
<%
    ...
    if (idParam == null || idParam.isEmpty()) {
        response.sendRedirect("listar_veiculos.jsp?msg=error"); return;
    }
    ...
    if ("sim".equals(request.getParameter("confirmar"))) {
        ...
        try {
            ...
            if (resultado > 0) { response.sendRedirect("listar_veiculos.jsp?msg=success"); }
            else { response.sendRedirect("listar_veiculos.jsp?msg=error"); }
        } catch (Exception e) {
            e.printStackTrace();
            response.sendRedirect("listar_veiculos.jsp?msg=error");
        } finally {
...
<head>
    ...
    <title>Eliminar Veículo - Escola de Condução</title>
...
<body>
    ...
    <div class="overlay">
        <div class="modal">
            ...
            <h2>Eliminar Veículo</h2>
            <p>Tens a certeza que queres eliminar este veículo?</p>
            ...
            <div class="btn-group">
                <a href="listar_veiculos.jsp" class="btn btn-secondary">
                    <i class="fa fa-times"></i> Cancelar
                </a>
                <a href="eliminar_veiculo.jsp?id=<%= id %>&confirmar=sim" class="btn btn-danger">
