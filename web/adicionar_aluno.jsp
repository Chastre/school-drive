<%-- 
    Document   : adicionar_aluno
    Created on : 16/12/2025, 14:27:21
    Author     : pmnch
--%>
...
<%
    ...
    if (request.getMethod().equals("POST")) {
        ...
        try {
            ...
            String sql = "INSERT INTO aluno (nome, email, telemovel, morada, dataNascimento, categoria, dataInscricao) VALUES (?, ?, ?, ?, ?, ?, ?)";
            ...
            if (resultado > 0) {
                ...
                response.sendRedirect("adicionar_aluno.jsp?msg=error");
                return;
            }
...
<head>
    <meta charset="utf-8">
    <title>Adicionar Aluno - Escola de Condução</title>
...
<body>
    ...
    <div class="container">
            ...
            <div class="form-header">
                ...
                <p>Preencha os dados abaixo para registar um novo aluno</p>
            </div>
            ...
            <% if (request.getParameter("msg") != null && request.getParameter("msg").equals("error")) { %>
                <div class="alert alert-error">
                    ...
                    <div>
                        ...
                        Erro ao adicionar aluno! Verifica os dados.
                    </div>
                </div>
            <% } %>

            <form method="POST" action="adicionar_aluno.jsp">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        <label>
                            ...
                            Data de Inscrição <span class="required">*</span>
                        </label>
                        <input type="date" name="dataInscricao" required 
                ...
                <div class="btn-group">
                    <a href="listar_alunos.jsp" class="btn btn-secondary">
