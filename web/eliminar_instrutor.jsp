<%-- 
    Document   : eliminar_instrutor
    Created on : 16/12/2025, 14:51:21
    Author     : pmnch
--%>
...
<%
    ...
    if (idParam == null || idParam.isEmpty()) {
        response.sendRedirect("listar_instrutores.jsp?msg=error"); return;
    }
    ...
    if ("sim".equals(request.getParameter("confirmar"))) {
        ...
        try {
            ...
            pstmt = conn.prepareStatement("DELETE FROM instrutor WHERE id = ?");
            pstmt.setInt(1, id);
            int resultado = pstmt.executeUpdate();
            if (resultado > 0) { response.sendRedirect("listar_instrutores.jsp?msg=success"); }
            else { response.sendRedirect("listar_instrutores.jsp?msg=error"); }
        } catch (Exception e) {
            e.printStackTrace();
            response.sendRedirect("listar_instrutores.jsp?msg=error");
        } finally {
...
<head>
    ...
    <title>Eliminar Instrutor - Escola de Condução</title>
...
<body>
    ...
    <div class="overlay">
        <div class="modal">
            ...
            <h2>Eliminar Instrutor</h2>
            <p>Tens a certeza que queres eliminar este instrutor?</p>
            ...
            <div class="btn-group">
                <a href="listar_instrutores.jsp" class="btn btn-secondary">
                    <i class="fa fa-times"></i> Cancelar
                </a>
                <a href="eliminar_instrutor.jsp?id=<%= id %>&confirmar=sim" class="btn btn-danger">
