<%-- 
    Document   : eliminar_aluno
    Created on : 16/12/2025, 14:30:07
    Author     : pmnch
--%>
...
<%
    ...
    if (idParam == null || idParam.isEmpty()) {
        response.sendRedirect("listar_alunos.jsp?msg=error"); return;
    }
    ...
    if ("sim".equals(request.getParameter("confirmar"))) {
        ...
        try {
            ...
            if (resultado > 0) { response.sendRedirect("listar_alunos.jsp?msg=success"); }
            else { response.sendRedirect("listar_alunos.jsp?msg=error"); }
        } catch (Exception e) {
            e.printStackTrace();
            response.sendRedirect("listar_alunos.jsp?msg=error");
        } finally {
...
<head>
    ...
    <title>Eliminar Aluno - Escola de Condução</title>
...
<body>
    ...
    <div class="overlay">
        <div class="modal">
            ...
            <p>Tens a certeza que queres eliminar este aluno?</p>
            ...
            <div class="btn-group">
                ...
                <a href="eliminar_aluno.jsp?id=<%= id %>&confirmar=sim" class="btn btn-danger">
