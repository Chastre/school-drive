<%-- 
    ...
    Created on : 16/12/2025, 14:28:33
    Author     : pmnch
--%>
...
<%
    ...
    if (request.getMethod().equals("POST")) {
        ...
        try {
            ...
            String sql = "UPDATE aluno SET nome=?, email=?, telemovel=?, morada=?, dataNascimento=?, categoria=?, dataInscricao=? WHERE id=?";
            ...
            pstmt.setDate(7, Date.valueOf(dataInscricao));
            pstmt.setInt(8, id);
            
            int resultado = pstmt.executeUpdate();
            
            if (resultado > 0) {
                response.sendRedirect("listar_alunos.jsp?msg=success");
                return;
            }
    ...
    if (idParam == null || idParam.isEmpty()) {
        response.sendRedirect("listar_alunos.jsp");
        return;
    }
...
<head>
    ...
    <title>Editar Aluno - Escola de Condução</title>
    ...
    <div class="container">
        <div class="form-card">
            <div class="form-header">
                <div class="icon-wrap"><i class="fa fa-user-edit"></i></div>
                <h1>Editar Aluno</h1>
            ...
            <form method="POST" action="editar_aluno.jsp">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label for="dataInscricao">Data de Inscrição <span class="required">*</span></label>
                    <input type="date" id="dataInscricao" name="dataInscricao" value="<%= dataInscricao %>" required>
                </div>
            ...
            <div class="btn-group">
                <a href="listar_alunos.jsp" class="btn btn-secondary">❌ Cancelar</a>
