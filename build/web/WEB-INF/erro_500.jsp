...
<head>
    <meta charset="UTF-8">
    <title>Erro interno - Drive School</title>
...
<body>
    <div class="card">
        <div class="icone"><i class="fa fa-tools"></i></div>
        <div class="codigo">500</div>
        <h1>Erro interno do servidor</h1>
        <p>Ocorreu um problema inesperado.<br>A equipa foi notificada. Tenta novamente em breve.</p>
        <div class="btns">
